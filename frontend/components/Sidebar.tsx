...
const TMS_CONFIG: ModuleConfig = {
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        { labelKey: "tms.vehicles", href: "/tms/vehicles", icon: Truck },
        { labelKey: "tms.drivers", href: "/tms/drivers", icon: Users },
        { labelKey: "tms.customers", href: "/tms/customers", icon: Building2 },
        { labelKey: "tms.locations", href: "/tms/locations", icon: MapPin },
